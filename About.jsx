...
import sign from '../images/aboutsign.png'
...
const About = () => {
  ...
  return (
    <section>
        <div id='about' className='px-16 flex flex-col'>
           <div className='flex mt-[100px]'>
           <div className='w-1/2 about1'>
                <h1 className=' font-bold text-7xl pt-14'>About Me</h1>
                <h4 className='font-semibold text-2xl text-slate-500 pt-8 mb-7'>I Really Love To Create Amazing Product
                </h4>
                <div className='about1 flex items-center gap-10 mt-14'>
                    <button className='bg-red-600 text-white px-7 py-4 rounded-lg hover:bg-black'>Download CV</button>
                    <div className='w-12 h-12 cursor-pointer text-lg font-bold border border-black rounded-[50%] flex justify-center hover:bg-red-600 items-center'>
                        FB
                    </div>
                    <div className='w-12 h-12 cursor-pointer text-lg font-bold border border-black rounded-[50%] flex justify-center hover:bg-red-600 items-center'>
                        TW
            ...
            <div className='about1 w-1/2 mt-14 text-slate-600 text-xl'>
                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod mpor ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exe citation ullamco nisi ut aliquip ex ea commodo consequat.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
           ...
           <div className='flex'>
             <div className='mt-10 w-1/2 about1'>
             ...
             <div className='w-1/2 mt-10 ml-10 flex flex-col items-center gap-3 about1'>
                 <div>
                    <h2 className=' font-bold text-4xl text-purple-950 text-center'>Wordpress</h2>
                    <p className='px-40 ml-24 mt-4 text-slate-500 text-[19px]'>lorem ipsum dolor sit amet, ectetur adipisicing elit, sed do it por includ ut labore dolore magna</p>
                 </div>
                 <div>
                    <h2 className='font-bold text-4xl text-yellow-600 text-center'>Javascript</h2>
                    <p className='px-40 ml-24 mt-4 text-slate-500 text-[19px]'>lorem ipsum dolor sit amet, ectetur adipisicing elit, sed do it por includ ut labore dolore magna</p>
                 </div>
                 <div>
                    <h2 className='font-bold text-4xl text-blue-700 text-center'>Bootstrap</h2>
                    <p className='px-40 ml-24 mt-4 text-slate-500 text-[19px]'>lorem ipsum dolor sit amet, ectetur adipisicing elit, sed do it por includ ut labore dolore magna</p>
                 </div>
             </div>
           </div>
